...
def cd(code)
  ...
  t << make_anchor( 'http://www.netdirect.co.jp/search/ISSSchDetail.asp?ISBN=' + keyword2, '旭屋' ) + ' / '
  ...
  t << make_anchor( 'http://search.www.tsutaya.co.jp/search_q/all/index.pl?RBT_SELECT=1&amp;TXT_SEARCH=&amp;TXT_SEARCH1=' + keyword_prefix + '&amp;TXT_SEARCH2=' + keyword_num + '&amp;BTN_SEARCH_2=%8C%9F%8D%F5%82%B7%82%E9', 'TSUTAYA' ) + ' 】'
