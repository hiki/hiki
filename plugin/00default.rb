# $Id: 00default.rb,v 1.9 2004-06-27 01:52:42 fdiary Exp $
...
def hiki_header
  ...
  <link rel="stylesheet" type="text/css" href="#{base_css_url.escape}" media="all">
  <link rel="stylesheet" type="text/css" href="#{theme_url.escape}" media="all">
EOS
